...
const TRANSLATIONS = {
    en: {
        ...
        'hero.nutritionWindow': 'Nutrition Windows',
        'nutrition.title': 'Optimal Nutrition Windows',
        'nutrition.description': 'Flat/gentle segments where eating is comfortable.',
        'nutrition.logic': 'Terrain with <10% grade for at least 300m.',
    ...
    de: {
        ...
        'hero.nutritionWindow': 'Verpflegungsfenster',
        'nutrition.title': 'Optimale Verpflegungsfenster',
        'nutrition.description': 'Flache/sanfte Abschnitte wo Essen angenehm ist.',
        'nutrition.logic': 'Gelände mit <10% Steigung für mindestens 300m.',
