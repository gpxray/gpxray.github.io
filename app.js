...
function showHeroPreview() {
    ...
    if (heroClimbLoad) {
        const officialElevation = currentDistanceConfig?.elevation;
...
function printRaceCard() {
    ...
    const printElevGain = currentDistanceConfig?.elevation || gpxData.elevationGain;
    ...
    try {
        ...
        card.innerHTML = `
            ...
            <div style="text-align: center;">
                ...
                <div style="font-size: 26px; font-weight: 500; color: #ddd; margin-bottom: 20px;">${distance.toFixed(0)}${unitLabel} | ${(currentDistanceConfig?.elevation || gpxData.elevationGain).toFixed(0)}m</div>
